{ this file is used by termtris.pas to communicate with learntris
  implementations.

  found at:
  http://luipack.googlecode.com/svn/trunk/miscutils/processlinetalk.pas
  
  part of the lazarus ui package (luipack) available under the LPGL
  (... probably with standard fpc modification to allow static linking?)
}
